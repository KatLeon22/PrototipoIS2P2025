...
namespace Capa_Vista_RRHH
{
    public partial class MDI_RRHH : Form
    {
        ...
        {
            frm_horaextra deptos = new frm_horaextra();
            deptos.Show();
        }
        ...
        private void inofrmesToolStripMenuItem_Click(object sender, EventArgs e)
        {
